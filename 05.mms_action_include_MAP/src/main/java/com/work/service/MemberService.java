...
//		return memberDao.updateMemberInfo(memberId, memberPw, name, mobile, email);
////		if(memberDao.updateMemberInfo(memberId, memberPw, name, mobile, email) >= 1) {
////			return 1;
////		} else {
////			return 0;
////		}
//	}
	...
	public int updateMemberInfo(Map<String, Object> dtoMap) {
		int result = memberDao.updateMemberInfo(dtoMap);
//		System.out.println("addMember result: " + result);
		return result;
	}
