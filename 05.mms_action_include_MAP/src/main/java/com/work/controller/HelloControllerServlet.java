...
public class HelloControllerServlet extends HttpServlet {
	...
	static {
		System.out.println("1. 서블릿 메모리 로딩 수행 : 2차변경");
	}
	
	public HelloControllerServlet() {
		System.out.println("2. 서블릿 객체 생성 수행 : 2차변경");
	}
...
//	}
	...
	public void init() throws ServletException {
		System.out.println("3. 서블릿 초기화 수행 : 2차변경");
	}
	 ...
	 */
	public void destroy() {
		System.out.println("5. 서블릿 자원해제 수행 : 2차변경");
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//System.out.println("4. Get 요청 서비스 수행 : 2차변경");
		// dispatch
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//System.out.println("4. Post 요청 서비스 수행 : 2차변경");
		process(request, response);
	}
